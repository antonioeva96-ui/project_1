...
1) Generate the monthly analyses (frequency of empty/full stations)
   ...
   - Output: data/curated/station_metrics_2018_08.csv and data/curated/station_metrics_2019_01.csv

2) Classify stations and save critical CSVs (including balanced)
   python src/critical_stations.py
...
3) Generate interactive maps
   ...
   - Output: map_ago2018.html, map_jan2019.html

Quick notes
- The critical CSVs also include balanced stations, sorted by severity.
- To change the criticality thresholds, update empty_THRESHOLD and full_THRESHOLD in src/critical_stations.py.
